...
#' @examples 
#' compras_agregadas <- 
#' aggregator_compras(c(2020), c("PE", "RS"), info_licitacoes = aggregator_licitacoes(c(2020), "covid", c("PE", "RS")))
aggregator_compras <- function(anos, administracao = c("PE", "RS"), info_licitacoes) {
