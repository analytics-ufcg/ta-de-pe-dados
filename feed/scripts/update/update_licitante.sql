...
(id_licitante, id_licitacao, id_orgao, nr_licitacao, ano_licitacao, cd_tipo_modalidade, tp_documento_licitante, 
...
SELECT id_licitante, id_licitacao, id_orgao, nr_licitacao, ano_licitacao, cd_tipo_modalidade, tp_documento_licitante, 
nr_documento_licitante, tp_documento_repres, nr_documento_repres, tp_condicao, 
tp_resultado_habilitacao, bl_beneficio_micro_epp
FROM temp_licitante
...
DO
  ...
  SET  
    ...
    id_licitante = EXCLUDED.id_licitante;
