...
#' Processa dados dos tipos documentos das licitações do estado do Rio Grande do Sul 
#' 
#' @return Dataframe com informações processadas dos tipos de documentos
#' 
#' @examples 
#' tipos_documento_licitacao_rs <- processa_tipos_documentos_licitacoes_rs()
processa_tipos_documentos_licitacoes_rs <- function() {
  tipos_documento_licitacao <- adapta_tipos_documento_licitacoes()
  
  return(tipos_documento_licitacao)
}